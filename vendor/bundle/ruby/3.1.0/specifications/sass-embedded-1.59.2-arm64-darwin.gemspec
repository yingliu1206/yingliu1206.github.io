# -*- encoding: utf-8 -*-
# stub: sass-embedded 1.59.2 arm64-darwin lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "documentation_uri" => "https://rubydoc.info/gems/sass-embedded/1.59.2", "funding_uri" => "https://github.com/sponsors/ntkme", "source_code_uri" => "https://github.com/ntkme/sass-embedded-host-ruby/tree/v1.59.2" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.48.0"])
    ...
    s.add_dependency(%q<rubocop>.freeze, ["~> 1.48.0"])
